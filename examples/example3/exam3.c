...
#define LON_TABLE1	55
#define POS_TABLE1	424L
...
#define LON_TABLE2	55
#define POS_TABLE2	5924L
...
#define LON_TABLE3	55
#define POS_TABLE3	11424L
...
/*--------------------------------------------------------------------
 ...
 +--------------------------------------------------------------------*/
static char *fichImagen  = "EXAM3.ibd";
static int   fdFBD	 = -1;
 ...
 *====================================================================*/
void EXAM3_Directorio(char *directorio)
{
	char *nuevoPath;
...
/*--------------------------------------------------------------------
 ...
 +--------------------------------------------------------------------*/
nuevoPath = (char *) malloc(strlen(directorio) + sizeof("EXAM3.ibd") + 1);
if (nuevoPath == NULL)
    ERR_SistOper(ERR_FATAL, FUNC_BDT, "EXAM3_Directorio", "malloc",
		 "(%d bytes) path de la base", lonMemoria);

/*--------------------------------------------------------------------
 | Se compone el nuevo path.
 +--------------------------------------------------------------------*/
sprintf(nuevoPath, "%s/EXAM3.ibd", directorio);
 ...
 *====================================================================*/
void EXAM3_Resize(int tabla, int dimension)
{
switch(tabla) {
    case TBL_TABLE1:
	/*------------------------------------------------------------
	...
	if (dimension > MAX_TABLE1)
	    ERR_Aplicacion(ERR_NO_FATAL, FUNC_BDT, "EXAM3_Resize",
 ...
 *====================================================================*/
void EXAM3_Overflow(int tabla, int desbord)
{
switch(tabla) {
    case TBL_TABLE1:
	ovfTable1 = desbord;
...
if (pMemoria == NULL) {
    ERR_SistOper(ERR_NO_FATAL, FUNC_BDT, "EXAM3_Inicializar", "malloc",
...
if (fichAbierto)
    if (close(fdFBD) == -1) {
	ERR_SistOper(ERR_NO_FATAL, FUNC_BDT, "EXAM3_Close", "close",
			"file \"%s\"", fichImagen);
	return -1;
	}
return 0;
 ...
 *====================================================================*/
int EXAM3_NumRecords(int tabla)
{
switch(tabla) {
    case TBL_TABLE1:
	return *numTable1;
 ...
 *====================================================================*/
int EXAM3_InsTable1(TypeTABLE1 *pTable1)
{
...
if (BuscaElemento(pTable1, clvSequenceTable1,
    ...
    ERR_Aplicacion(ERR_NO_FATAL, FUNC_BDT, "EXAM3_InsTable1",
 ...
 *	-1: si se produce un error.
 *====================================================================*/
int EXAM3_DelTable1(TypeTABLE1 *pTable1)
{
	char elemCod[LON_TABLE1];
	int  posicMem;
	int  posicFic;
...
if (indElem == -1) {
    ERR_Aplicacion(ERR_NO_FATAL, FUNC_BDT, "EXAM3_EliTable1",
 ...
 *	-1: si se produce un error.
 *====================================================================*/
int EXAM3_ModTable1(TypeTABLE1 *pTable1)
{
	char elemCod[LON_TABLE1];
	int  posicMem;
	int  posicFic;
...
indElem = BuscaElemento(pTable1, clvSequenceTable1,
		*numTable1, (PF_COMPAR)CmpSequenceTable1);
if (indElem == -1) {
    ERR_Aplicacion(ERR_NO_FATAL, FUNC_BDT, "EXAM3_ModTable1",
		   "key SEQUENCE of TABLE1 not exists");
    return -1;
    }
 ...
 *	Busca un elemento
 *====================================================================*/
int EXAM3_Table1BySequence(TypeTABLE1 *pTable1,
				int            mykey1)
{
	int  indElem;
...
if (pTable1 == NULL) {
    ERR_SistOper(ERR_NO_FATAL, FUNC_BDT, "EXAM3_VolTable1",
 ...
 *	-1: si se produce un error.
 *====================================================================*/
int EXAM3_InsTable2(TypeTABLE2 *pTable2)
{
...
if (BuscaElemento(pTable2, clvSequenceTable2,
    ...
    ERR_Aplicacion(ERR_NO_FATAL, FUNC_BDT, "EXAM3_InsTable2",
 ...
 *	-1: si se produce un error.
 *====================================================================*/
int EXAM3_DelTable2(TypeTABLE2 *pTable2)
{
	char elemCod[LON_TABLE2];
	int  posicMem;
	int  posicFic;
...
if (indElem == -1) {
    ERR_Aplicacion(ERR_NO_FATAL, FUNC_BDT, "EXAM3_EliTable2",
 ...
 *	-1: si se produce un error.
 *====================================================================*/
int EXAM3_ModTable2(TypeTABLE2 *pTable2)
{
	char elemCod[LON_TABLE2];
	int  posicMem;
	int  posicFic;
...
indElem = BuscaElemento(pTable2, clvSequenceTable2,
		*numTable2, (PF_COMPAR)CmpSequenceTable2);
if (indElem == -1) {
    ERR_Aplicacion(ERR_NO_FATAL, FUNC_BDT, "EXAM3_ModTable2",
		   "key SEQUENCE of TABLE2 not exists");
    return -1;
    }
 ...
 *	Busca un elemento
 *====================================================================*/
int EXAM3_Table2BySequence(TypeTABLE2 *pTable2,
				int            mykey2)
{
	int  indElem;
...
if (pTable2 == NULL) {
    ERR_SistOper(ERR_NO_FATAL, FUNC_BDT, "EXAM3_VolTable2",
 ...
 *	-1: si se produce un error.
 *====================================================================*/
int EXAM3_InsTable3(TypeTABLE3 *pTable3)
{
...
if (BuscaElemento(pTable3, clvSequenceTable3,
    ...
    ERR_Aplicacion(ERR_NO_FATAL, FUNC_BDT, "EXAM3_InsTable3",
 ...
 *	-1: si se produce un error.
 *====================================================================*/
int EXAM3_DelTable3(TypeTABLE3 *pTable3)
{
	char elemCod[LON_TABLE3];
	int  posicMem;
	int  posicFic;
...
if (indElem == -1) {
    ERR_Aplicacion(ERR_NO_FATAL, FUNC_BDT, "EXAM3_EliTable3",
 ...
 *	-1: si se produce un error.
 *====================================================================*/
int EXAM3_ModTable3(TypeTABLE3 *pTable3)
{
	char elemCod[LON_TABLE3];
	int  posicMem;
	int  posicFic;
...
indElem = BuscaElemento(pTable3, clvSequenceTable3,
		*numTable3, (PF_COMPAR)CmpSequenceTable3);
if (indElem == -1) {
    ERR_Aplicacion(ERR_NO_FATAL, FUNC_BDT, "EXAM3_ModTable3",
		   "key SEQUENCE of TABLE3 not exists");
    return -1;
    }
 ...
 *	Busca un elemento
 *====================================================================*/
int EXAM3_Table3BySequence(TypeTABLE3 *pTable3,
				int            mykey3)
{
	int  indElem;
...
if (pTable3 == NULL) {
    ERR_SistOper(ERR_NO_FATAL, FUNC_BDT, "EXAM3_VolTable3",
...
if (access(fichImagen, F_OK) == -1) {
    ERR_Aplicacion(ERR_NO_FATAL, FUNC_BDT, "EXAM3: IniInformacion",
...
if (fdFBD == -1) {
    ERR_SistOper(ERR_NO_FATAL, FUNC_BDT, "EXAM3: IniInformacion", "open",
...
if (bufElems == NULL)
    ERR_SistOper(ERR_FATAL, FUNC_BDT, "EXAM3 IniInformacion", "malloc",
...
if (lseek(fdFBD, POS_TABLE1, SEEK_SET) == -1) {
    ERR_SistOper(ERR_NO_FATAL, FUNC_BDT, "EXAM3: IniInformacion", "lseek",
...
if (read(fdFBD, bufElems, BUF_TABLE1) != BUF_TABLE1) {
    ERR_SistOper(ERR_NO_FATAL, FUNC_BDT, "EXAM3: IniInformacion", "read",
...
if (! fichAbierto)
    if (close(fdFBD) == -1) {
	ERR_SistOper(ERR_NO_FATAL, FUNC_BDT, "EXAM3: IniInformacion", "close",
		     "file \"%s\"", fichImagen);
	return -1;
	}
...
TPC_CodChar(pTable1->text, 50, elem + 5);
}
...
TPC_DecChar(pTable1->text, 50, elem + 5);
}
...
ERR_Aplicacion(ERR_NO_FATAL, FUNC_BDT, "EXAM3: KeyTable1",
...
TPC_CodChar(pTable2->text, 50, elem + 5);
}
...
TPC_DecChar(pTable2->text, 50, elem + 5);
}
...
ERR_Aplicacion(ERR_NO_FATAL, FUNC_BDT, "EXAM3: KeyTable2",
...
TPC_CodChar(pTable3->text, 50, elem + 5);
}
...
TPC_DecChar(pTable3->text, 50, elem + 5);
}
...
ERR_Aplicacion(ERR_NO_FATAL, FUNC_BDT, "EXAM3: KeyTable3",
...
if (! fichAbierto) {
    fdFBD = open(fichImagen, O_RDWR | O_EXCL);
    if (fdFBD == -1) {
	ERR_SistOper(ERR_NO_FATAL, FUNC_BDT, "EXAM3: ActElemento", "open",
		 "file \"%s\" (for read/write))", fichImagen);
	return -1;
	}
    }
...
if (lseek(fdFBD, (off_t)posFic, SEEK_SET) == -1) {
    ERR_SistOper(ERR_NO_FATAL, FUNC_BDT, "EXAM3: ActElemento", "lseek",
...
if (write(fdFBD, (char *)eleFic, lonFic) != lonFic) {
    ERR_SistOper(ERR_NO_FATAL, FUNC_BDT, "EXAM3: ActElemento", "write",
...
if (! fichAbierto)
    if (close(fdFBD) == -1) {
	ERR_SistOper(ERR_NO_FATAL, FUNC_BDT, "EXAM3: ActElemento", "close",
		     "file \"%s\"", fichImagen);
	return -1;
	}
